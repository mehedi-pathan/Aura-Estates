              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="e.g. 1500" className="h-12 border-2 focus:border-primary transition-colors" />
                  </div>

                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground">Max Square Feet</label>
                    <Input placeholder="e.g. 5000" className="h-12 border-2 focus:border-primary transition-colors" />
                  </div>
                </div>
              </motion.div>
            )}
